...
avrg_win_df = pd.read_csv("../monteCarlo_tour/results_second/single_results_1000_200_dev{}/winners_m1000_t200_dev{}.csv".format(dev_t, dev_t), index_col=0, converters={'column_name': eval})
avrg_norm_df = pd.read_csv("../monteCarlo_tour/results_second/single_results_1000_200_dev{}/normed_m1000_t200_dev{}.csv".format(dev_t, dev_t), index_col=0, converters={'column_name': eval})
